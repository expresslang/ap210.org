...
import { programmingNavigation } from '@/data/navigation'

const content = await useContent('programming', 'index')
</script>

<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="lg:grid lg:grid-cols-[220px_1fr] lg:gap-10">
      <TheSidebar :items="programmingNavigation" base-path="/learn/programming" />
      <div>

...
const imagesDirs: Record<string, string> = {
  ...
  standards: '/images/standards',
  research: '/images/research',
  foundations: '/images/learn',
  'ap210-concepts': '/images/learn',
  'reading-data': '/images/learn',
  'querying-data': '/images/learn',
  programming: '/images/learn',
}
